...
flowchart LR
    ...
    FE_ACTIONS -->|POST /api/runs/{id}/upload| BE_API
    FE_ACTIONS -->|POST /api/runs/{id}/start| BE_API
    FE_ACTIONS -->|GET /api/runs/{id}| BE_API
    FE_ACTIONS -->|DELETE /api/runs/{id}| BE_API
